defmodule PhonebookWeb.Schema.Subscriptions.UserTest do
  use PhonebookWeb.SubcriptionCase
  ...
  @update_user_pref_subs_doc """
    subscription UpdateUserPreferences($user_id: ID!){
    updatedUserPreferences(userId: $user_id){
      userId
      likesEmails
    }
  }
